...
var _htmlElementsJs = require("./htmlElements.js");
var _dateFns = require("date-fns");
var _locale = require("date-fns/locale");
(0, _htmlElementsJs.HTML_ELEMENTS).CITY_INPUT.value = "Moscow";
function getCityName() {
    let cityName = (0, _htmlElementsJs.HTML_ELEMENTS).CITY_INPUT.value.trim();
    if (!isNaN(Number(cityName)) || cityName.length === 0) throw new (0, _errorsJs.CityInputError)("wrong city name given");
    (0, _apiJs.API).cityName = cityName;
    (0, _apiJs.API).url = `${(0, _apiJs.API).serverUrl}?q=${(0, _apiJs.API).cityName}&appid=${(0, _apiJs.API).apiKey}`;
}
function changeCityNames(times = 0) {
    if (times === (0, _htmlElementsJs.HTML_ELEMENTS).CITY_NAMES.length) return;
    (0, _htmlElementsJs.HTML_ELEMENTS).CITY_NAMES[times].textContent = (0, _apiJs.API).cityName;
    return changeCityNames(times + 1);
}
function changeWeatherHtml(weather) {
    (0, _htmlElementsJs.HTML_ELEMENTS).DEGREES_NUM.textContent = Math.round(Number(weather.main.temp) - 273);
    (0, _htmlElementsJs.HTML_ELEMENTS).DETAIL_TEMPETURE.textContent = `Tempeture: ${Math.round(Number(weather.main.temp) - 273)}`;
    (0, _htmlElementsJs.HTML_ELEMENTS).FEELS_LIKE.textContent = `Feels like: ${Math.round(Number(weather.main.feels_like) - 273)}`;
    (0, _htmlElementsJs.HTML_ELEMENTS).WEATHER.textContent = `Weather: ${weather.weather[0].main}`;
    (0, _htmlElementsJs.HTML_ELEMENTS).SUNRISE.textContent = `Sunrise: ${(0, _dateFns.format)(weather.sys.sunrise * 1000, "H")}:${(0, _dateFns.format)(weather.sys.sunrise * 1000, "mm")}`;
    (0, _htmlElementsJs.HTML_ELEMENTS).SUNSET.textContent = `Sunset: ${(0, _dateFns.format)(weather.sys.sunset * 1000, "H")}:${(0, _dateFns.format)(weather.sys.sunset * 1000, "mm")}`;
    changeCityNames();
}
function sendRequest() {
    getCityName();
    fetch((0, _apiJs.API).url).catch((error)=>{
        throw new error;
    }).then((data)=>{
        data.json().then((data)=>{
...
(0, _htmlElementsJs.HTML_ELEMENTS).FORECAST_FORM.addEventListener("submit", function(event) {
    event.preventDefault();
    sendRequest();
});

},{"./errors.js":"270rW","./api.js":"eqUwj","./htmlElements.js":"3FryE","date-fns":"9yHCA","date-fns/locale":"lASMG"}],"270rW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CityInputError", ()=>CityInputError);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3FryE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "HTML_ELEMENTS", ()=>HTML_ELEMENTS);
const HTML_ELEMENTS = {
    ...
    DETAIL_TEMPETURE: document.querySelector("#detail-tempeture"),
...
},{"./_lib/formatDistance/index.js":"2pEPG","./_lib/formatLong/index.js":"4XnlZ","./_lib/formatRelative/index.js":"d4JyI","./_lib/localize/index.js":"imN95","./_lib/match/index.js":"hickd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2pEPG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var formatDistanceLocale = {
    lessThanXSeconds: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4XnlZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../../_lib/buildFormatLongFn/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../../_lib/buildFormatLongFn/index.js":"h1FGd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d4JyI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var formatRelativeLocale = {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"imN95":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../../_lib/buildLocalizeFn/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../../_lib/buildLocalizeFn/index.js":"5l2rZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hickd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../../_lib/buildMatchFn/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../../_lib/buildMatchFn/index.js":"2nEf9","../../../_lib/buildMatchPatternFn/index.js":"4GjCS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dpgAG","6rimH"], "6rimH", "parcelRequire3e4c")
