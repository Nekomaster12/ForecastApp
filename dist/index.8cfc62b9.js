...
function sendRequest() {
    getCityName();
    fetch((0, _apiJs.API).url).catch(()=>{
        throw new (0, _errorsJs.fetchError)("Fetch error.");
    }).then((data)=>{
        data.json().then((data)=>{
...
function addToFavouriteCities() {
    fetch((0, _apiJs.API).url).catch(()=>{
        throw new (0, _errorsJs.fetchError)("City add error.");
    }).then(()=>{
        if (favouriteCityList.length >= 8) favouriteCityList.shift();
        favouriteCityList.unshift((0, _apiJs.API).cityName);
...
},{"./errors.js":"270rW","./api.js":"eqUwj","./htmlElements.js":"3FryE","date-fns":"9yHCA"}],"270rW":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dpgAG","6rimH"], "6rimH", "parcelRequire3e4c")
